...
<Info>**This script enables the installation of any app from our [app catalog](zappl.co/app-catalog).** It eliminates the need for Jamf Pro admins to manually package and deploy software. For instructions on using this script, refer to Adding Scripts to Jamf Pro below.</Info>
