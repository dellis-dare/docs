...
title: 'Preferences'
icon: 'code'
description: 'If you are looking to customise the JSON Schema in Jamf Pro or XML for other MDMs, you can use this guide to understand the purpose of each preference key.'
---
